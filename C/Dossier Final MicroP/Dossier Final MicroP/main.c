...
#define BaseDelayMicroSeconds 125 //125�s
...
int main(void)
{
	...
	do
	{
		...
		case 'C':
			...
			break;
		/*
		//(C)lignoter : activation du clignotement de la LED sur la broche x (x est compris entre 0 et 7) gr�ce � le gestion d�une interruption sur un timer. De cette mani�re le LED clignote en continu et le programme continue � fonctionner pour les autres options. Une seule LED peut clignoter � un moment donn�. Le changement de l'�tat de la LED se fait toutes les 0,5 secondes.
		case 'C':
			break;
		//(S)topper : arr�t du clignotement de la LED.
		case 'S':
			break;
		*/
		default:
